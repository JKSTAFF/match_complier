...
git clone -b packages-23.05 https://github.com/JKSTAFF/match_complier.git package/custom --recurse-submodules
# Remove packages already in official repository
rm -rf package/custom/sms-tool/sms-tool
